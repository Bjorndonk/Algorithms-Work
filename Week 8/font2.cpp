...
void recursiveSentence(long int arr[], int data[], int start, int end, int index, long int sentence_size, long int *num_valid_sentences) {
    ...
    if (index == sentence_size) {
        ...
        if (curr_sentence_value == 0) {
            *num_valid_sentences = 10;
            return;
        }
        /*
        if (curr_sentence_value == compare) {
            *num_valid_sentences = 3;
        }
        */
    }
...
int main() {
    ...
    */
    ...
    // Running Algorithm
    long int num_valid_sentences = 1;
